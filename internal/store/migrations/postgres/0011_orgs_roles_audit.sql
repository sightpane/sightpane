-- Organisations, fine-grained roles (owner, admin, member, viewer), audit log and scoped API tokens.
...
-- Data migration: backfill orgs and org_members for existing projects
DO $$
DECLARE
  p RECORD;
  new_org_id BIGINT;
